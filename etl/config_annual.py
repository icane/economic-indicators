...
params = {
    ...
    'series': {
        ...
        'pib_indice_volumen': {
            ...
            'note': ['Para Cantabria, los datos de 2017 son provisionales, 2018 son avance y 2019 primera estimación. Para España los datos de 2019 son provisionales y 2020 son avance'],
            'json': {
